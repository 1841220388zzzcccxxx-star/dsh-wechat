...
.dxw-badge { display: inline-flex; align-items: center; gap: 7px; min-height: 30px; padding: 0 11px; border-radius: 999px; color: var(--dsw-alias-label-secondary, #646a73); background: var(--dsw-alias-bg-layer-2, #f2f3f5); font-size: 12px; white-space: nowrap; }
.dxw-dot { width: 8px; height: 8px; border-radius: 50%; background: var(--dsw-alias-label-tertiary, #aeb3bb); flex: none; }
...
.dxw-button { min-height: 34px; border: 1px solid var(--dsw-alias-border-l1, #dfe1e5); border-radius: 8px; padding: 0 13px; display: inline-flex; align-items: center; justify-content: center; gap: 7px; color: var(--dsw-alias-label-primary, #1f2329); background: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: 13px; font-weight: 560; cursor: pointer; text-decoration: none; transition: border-color .15s ease, background .15s ease, transform .15s ease; }
.dxw-button:hover:not(:disabled) { border-color: var(--dsw-alias-label-tertiary, #aeb3bb); background: var(--dsw-alias-bg-layer-2, #f7f8fa); }
...
.dxw-card { overflow: hidden; border: 1px solid var(--dsw-alias-border-l1, #e5e6eb); border-radius: 14px; background: var(--dsw-alias-bg-layer-1, #fff); box-shadow: 0 1px 2px rgb(31 35 41 / 3%); }
...
.dxw-qrFrame { position: relative; width: 270px; aspect-ratio: 1; display: grid; place-items: center; overflow: hidden; padding: 10px; border: 1px solid var(--dsw-alias-border-l1, #e5e6eb); border-radius: 16px; background: var(--dsw-alias-bg-layer-1, white); }
...
.dxw-progress { height: 4px; overflow: hidden; border-radius: 99px; background: var(--dsw-alias-bg-layer-2, #eef0f3); }
...
.dxw-input { width: 190px; height: 42px; padding: 0 14px; border: 1px solid var(--dsw-alias-border-l1, #dfe1e5); border-radius: 9px; background: var(--dsw-alias-bg-layer-1, white); color: inherit; font: inherit; font-size: 18px; letter-spacing: .16em; text-align: center; }
...
.dxw-metric { padding: 12px 14px; border-radius: 9px; background: var(--dsw-alias-bg-layer-2, #f7f8fa); }
...
.dxw-spinner { width: 24px; height: 24px; margin: 0 auto 12px; border: 3px solid var(--dsw-alias-border-l1, #e6e8eb); border-top-color: var(--dxw-accent); border-radius: 50%; animation: dxw-spin .8s linear infinite; }
